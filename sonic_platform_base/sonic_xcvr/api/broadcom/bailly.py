...
class BaillyApi(CmisApi):
    RLM_THRESHOLD_FIELDS = {
        "rlm_temphighalarm": bailly.RLM_TEMP_HIGH_ALARM_FIELD,
        "rlm_templowalarm": bailly.RLM_TEMP_LOW_ALARM_FIELD,
        "rlm_temphighwarning": bailly.RLM_TEMP_HIGH_WARNING_FIELD,
        "rlm_templowwarning": bailly.RLM_TEMP_LOW_WARNING_FIELD,
        "rlm_vcchighalarm": bailly.RLM_VCC_HIGH_ALARM_FIELD,
        "rlm_vcclowalarm": bailly.RLM_VCC_LOW_ALARM_FIELD,
        "rlm_vcchighwarning": bailly.RLM_VCC_HIGH_WARNING_FIELD,
        "rlm_vcclowwarning": bailly.RLM_VCC_LOW_WARNING_FIELD,
        "rlm_txpowerhighalarm": bailly.RLM_TX_POWER_HIGH_ALARM_FIELD,
        "rlm_txpowerlowalarm": bailly.RLM_TX_POWER_LOW_ALARM_FIELD,
        "rlm_txpowerhighwarning": bailly.RLM_TX_POWER_HIGH_WARNING_FIELD,
        "rlm_txpowerlowwarning": bailly.RLM_TX_POWER_LOW_WARNING_FIELD,
        "rlm_txbiashighalarm": bailly.RLM_TX_BIAS_HIGH_ALARM_FIELD,
        "rlm_txbiashighwarning": bailly.RLM_TX_BIAS_HIGH_WARNING_FIELD,
    }
    ...
    def get_rlm_monitor_values(self):
        ...
        monitor_values = {
            "rlm_temperature": self._format_float(monitors.get(bailly.MODULE_TEMPERATURE_MONITOR)),
            "rlm_voltage": self._format_float(monitors.get(bailly.MODULE_SUPPLY_VOLTAGE_MONITOR)),
    ...
    def get_rlm_flags(self):
        ...
        flags = {
            "rlm_tempHAlarm": module_alarms.get(bailly.TEMP_HIGH_ALARM_FLAG),
            "rlm_tempLAlarm": module_alarms.get(bailly.TEMP_LOW_ALARM_FLAG),
            "rlm_tempHWarn": module_alarms.get(bailly.TEMP_HIGH_WARN_FLAG),
            "rlm_tempLWarn": module_alarms.get(bailly.TEMP_LOW_WARN_FLAG),
            "rlm_vccHAlarm": module_alarms.get(bailly.VOLTAGE_HIGH_ALARM_FLAG),
            "rlm_vccLAlarm": module_alarms.get(bailly.VOLTAGE_LOW_ALARM_FLAG),
            "rlm_vccHWarn": module_alarms.get(bailly.VOLTAGE_HIGH_WARN_FLAG),
            "rlm_vccLWarn": module_alarms.get(bailly.VOLTAGE_LOW_WARN_FLAG),
        }
    ...
    def get_rlm_status(self):
        ...
        return {
            "rlm_module_low_power_state": status.get(bailly.MODULE_LOW_POWER_STATE),
            "rlm_interrupt_status": status.get(bailly.INTL_INTERRUPT_STATUS),
        }
    ...
    def get_transceiver_info(self):
        ...
        if cpo_info is not None:
            info.update({
                "rlm_identifier": cpo_info.get(bailly.CPO_IDENTIFIER),
                "rlm_revision": self._format_revision(cpo_info.get(bailly.CPO_REVISION)),
                "rlm_laser_wavelength_grid": cpo_info.get(bailly.LASER_WAVELENGTH_GRID),
                "rlm_laser_count": cpo_info.get(bailly.LASER_COUNT),
            })
        ...
        if rlm_vendor_info is not None:
            info.update({
                ...
                "rlm_vendor_oui": rlm_vendor_info.get(bailly.VENDOR_OUI_HEX_FIELD),
                ...
                "rlm_max_power": rlm_vendor_info.get(bailly.MAX_POWER_CONSUMPTION_FIELD),
            })
