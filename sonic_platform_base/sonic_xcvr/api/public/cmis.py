...
class CmisApi(XcvrApi):
    ...
    def get_transceiver_threshold_info(self):
        ...
        tx_bias_current_dict = self.get_txbias()
        trans_dom_th['txbiashighalarm'] = tx_bias_dict['high alarm']
        trans_dom_th['txbiaslowalarm'] = tx_bias_dict['low alarm']
        trans_dom_th['txbiashighwarning'] = tx_bias_dict['high warn']
        trans_dom_th['txbiaslowwarning'] = tx_bias_dict['low warn']
        laser_temp_dict = self.get_laser_temperature()
    ...
    def get_transceiver_status(self):
        ...
        trans_status['rxoutput_status_hostlane1'] = tx_output_status_dict['RX_lane1']
        trans_status['rxoutput_status_hostlane2'] = tx_output_status_dict['RX_lane2']
        trans_status['rxoutput_status_hostlane3'] = tx_output_status_dict['RX_lane3']
        trans_status['rxoutput_status_hostlane4'] = tx_output_status_dict['RX_lane4']
        trans_status['rxoutput_status_hostlane5'] = tx_output_status_dict['RX_lane5']
        trans_status['rxoutput_status_hostlane6'] = tx_output_status_dict['RX_lane6']
        trans_status['rxoutput_status_hostlane7'] = tx_output_status_dict['RX_lane7']
        trans_status['rxoutput_status_hostlane8'] = tx_output_status_dict['RX_lane8']
        ...
        trans_status['rxpowerhighalarm_flag'] = rx_power_flag_dict['tx_power_high_alarm']['RX_lane1']
        trans_status['rxpowerlowalarm_flag'] = rx_power_flag_dict['tx_power_low_alarm']['RX_lane1']
        trans_status['rxpowerhighwarning_flag'] = rx_power_flag_dict['tx_power_high_warn']['RX_lane1']
        trans_status['rxpowerlowwarning_flag'] = rx_power_flag_dict['tx_power_low_warn']['RX_lane1']
        ...
        trans_dom_th['cdshorthighalarm_flag'] = vdm_dict['CD high granularity, short link [ps/nm]'][1][5]
        trans_dom_th['cdshortlowalarm_flag'] = vdm_dict['CD high granularity, short link [ps/nm]'][1][6]
        trans_dom_th['cdshorthighwarning_flag'] = vdm_dict['CD high granularity, short link [ps/nm]'][1][7]
        trans_dom_th['cdshortlowwarning_flag'] = vdm_dict['CD high granularity, short link [ps/nm]'][1][8]
        trans_dom_th['cdlonghighalarm_flag'] = vdm_dict['CD low granularity, long link [ps/nm]'][1][5]
        trans_dom_th['cdlonglowalarm_flag'] = vdm_dict['CD low granularity, long link [ps/nm]'][1][6]
        trans_dom_th['cdlonghighwarning_flag'] = vdm_dict['CD low granularity, long link [ps/nm]'][1][7]
        trans_dom_th['cdlonglowwarning_flag'] = vdm_dict['CD low granularity, long link [ps/nm]'][1][8]
        trans_dom_th['dgdhighalarm_flag'] = vdm_dict['DGD [ps]'][1][5]
        trans_dom_th['dgdlowalarm_flag'] = vdm_dict['DGD [ps]'][1][6]
        trans_dom_th['dgdhighwarning_flag'] = vdm_dict['DGD [ps]'][1][7]
        trans_dom_th['dgdlowwarning_flag'] = vdm_dict['DGD [ps]'][1][8]
        trans_dom_th['sopmdhighalarm_flag'] = vdm_dict['SOPMD [ps^2]'][1][5]
        trans_dom_th['sopmdlowalarm_flag'] = vdm_dict['SOPMD [ps^2]'][1][6]
        trans_dom_th['sopmdhighwarning_flag'] = vdm_dict['SOPMD [ps^2]'][1][7]
        trans_dom_th['sopmdlowwarning_flag'] = vdm_dict['SOPMD [ps^2]'][1][8]
        trans_dom_th['pdlhighalarm_flag'] = vdm_dict['PDL [dB]'][1][5]
        trans_dom_th['pdllowalarm_flag'] = vdm_dict['PDL [dB]'][1][6]
        trans_dom_th['pdlhighwarning_flag'] = vdm_dict['PDL [dB]'][1][7]
        trans_dom_th['pdllowwarning_flag'] = vdm_dict['PDL [dB]'][1][8]
        trans_dom_th['osnrhighalarm_flag'] = vdm_dict['OSNR [dB]'][1][5]
        trans_dom_th['osnrlowalarm_flag'] = vdm_dict['OSNR [dB]'][1][6]
        trans_dom_th['osnrhighwarning_flag'] = vdm_dict['OSNR [dB]'][1][7]
        trans_dom_th['osnrlowwarning_flag'] = vdm_dict['OSNR [dB]'][1][8]
        trans_dom_th['esnrhighalarm_flag'] = vdm_dict['eSNR [dB]'][1][5]
        trans_dom_th['esnrlowalarm_flag'] = vdm_dict['eSNR [dB]'][1][6]
        trans_dom_th['esnrhighwarning_flag'] = vdm_dict['eSNR [dB]'][1][7]
        trans_dom_th['esnrlowwarning_flag'] = vdm_dict['eSNR [dB]'][1][8]
        trans_dom_th['cfohighalarm_flag'] = vdm_dict['CFO [MHz]'][1][5]
        trans_dom_th['cfolowalarm_flag'] = vdm_dict['CFO [MHz]'][1][6]
        trans_dom_th['cfohighwarning_flag'] = vdm_dict['CFO [MHz]'][1][7]
        trans_dom_th['cfolowwarning_flag'] = vdm_dict['CFO [MHz]'][1][8]
        trans_dom_th['txcurrpowerhighalarm_flag'] = vdm_dict['Tx Power [dBm]'][1][5]
        trans_dom_th['txcurrpowerlowalarm_flag'] = vdm_dict['Tx Power [dBm]'][1][6]
        trans_dom_th['txcurrpowerhighwarning_flag'] = vdm_dict['Tx Power [dBm]'][1][7]
        trans_dom_th['txcurrpowerlowwarning_flag'] = vdm_dict['Tx Power [dBm]'][1][8]
        trans_dom_th['rxtotpowerhighalarm_flag'] = vdm_dict['Rx Total Power [dBm]'][1][5]
        trans_dom_th['rxtotpowerlowalarm_flag'] = vdm_dict['Rx Total Power [dBm]'][1][6]
        trans_dom_th['rxtotpowerhighwarning_flag'] = vdm_dict['Rx Total Power [dBm]'][1][7]
        trans_dom_th['rxtotpowerlowwarning_flag'] = vdm_dict['Rx Total Power [dBm]'][1][8]
        trans_dom_th['rxsigpowerhighalarm_flag'] = vdm_dict['Rx Signal Power [dBm]'][1][5]
        trans_dom_th['rxsigpowerlowalarm_flag'] = vdm_dict['Rx Signal Power [dBm]'][1][6]
        trans_dom_th['rxsigpowerhighwarning_flag'] = vdm_dict['Rx Signal Power [dBm]'][1][7]
        trans_dom_th['rxsigpowerlowwarning_flag'] = vdm_dict['Rx Signal Power [dBm]'][1][8]
        return trans_status
    ...
    def get_transceiver_PM(self):
        ...
        trans_pm['rx_tot_power_avg'] = PM_dict['rx_tot_power_avg']
        trans_pm['rx_tot_power_min'] = PM_dict['rx_tot_power_min']
        trans_pm['rx_tot_power_max'] = PM_dict['rx_tot_power_max']
        trans_pm['rx_sig_power_avg'] = PM_dict['rx_sig_power_avg']
        trans_pm['rx_sig_power_min'] = PM_dict['rx_sig_power_min']
        trans_pm['rx_sig_power_max'] = PM_dict['rx_sig_power_max']
        return trans_pm
