...
class CmisMemMap(XcvrMemMap):
    def __init__(self, codes):
        ...
        self.ADMIN_INFO = RegGroupField(consts.ADMIN_INFO_FIELD,
            ...
            CodeRegField(consts.CONNECTOR_FIELD, get_addr(0x0, 203), self.codes.CONNECTORS),
        ...
        self.TRANS_MODULE_STATUS = RegGroupField(consts.TRANS_MODULE_STATUS_FIELD,
            ...
            CodeRegField(consts.MODULE_FAULT_CAUSE, get_addr(0x0, 41), self.codes.MODULE_FAULT_CAUSE),
        )
