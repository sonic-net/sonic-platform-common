...
class CmisMemMap(XcvrMemMap):
    def __init__(self, codes):
        ...
        self.MEDIA_LANE_FEC_PM = RegGroupField(
        ...
        self.MEDIA_LANE_LINK_PM = RegGroupField(
            ...
            NumberRegField(consts.RX_AVG_DGD_PM_FIELD, get_addr(0x35, 140), format=">H", size=2, scale=100.0)
            # TODO: add others PMs...
        )
